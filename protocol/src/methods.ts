...
import {
  ...
  profileUpdateSchema,
  sessionCreateSchema,
  sessionDownloadStartSchema,
  sessionEditStartSchema,
  sessionExecCancelSchema,
  sessionExecStartSchema,
...
export const rpcMethodSchemas = {
  ...
  'sessions.execStart': sessionExecStartSchema,
  'sessions.execStatus': sessionExecStatusSchema,
  'sessions.execCancel': sessionExecCancelSchema,
  'sessions.uploadStart': sessionUploadStartSchema,
  'sessions.downloadStart': sessionDownloadStartSchema,
  'sessions.editStart': sessionEditStartSchema,

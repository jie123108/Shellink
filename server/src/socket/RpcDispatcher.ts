  ...
  async dispatch(method: string, input: unknown, sink: SubscriptionSink): Promise<unknown> {
    ...
    try {
      switch (method as RpcMethod) {
        ...
        case 'sessions.execStart': return sessionService.execStart(params)
        case 'sessions.execStatus': return await sessionService.execStatus(params)
        case 'sessions.execCancel': return await sessionService.execCancel(params)
        case 'sessions.uploadStart': return sessionService.uploadStart(params)
        case 'sessions.downloadStart': return sessionService.downloadStart(params)
        case 'sessions.editStart': return sessionService.editStart(params)
